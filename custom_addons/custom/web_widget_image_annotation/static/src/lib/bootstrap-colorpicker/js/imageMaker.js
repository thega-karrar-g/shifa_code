...
//            </button>
          ...
          <div class="wrapper-amm-stop-brushes">
           ...
           <input type="color" data-on="brushes" class="amm-color-picker colorSelectorBrushes" name="colorSelectorBrushes" value="#000000" List/>
    ...
    <a type="submit" class="generate_meme btn btn-default btn-primary form-submit" disabled="disabled" >`+canvas_info.i18n.imageGeneratorText+`</a>
