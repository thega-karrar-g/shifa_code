...
class VitalSigns(models.Model):
    _name = 'sm.shifa.vital.signs'
    _description = 'Vital Signs'
    _rec_name = 'vital_signs_code'
    ...
    vital_signs_code = fields.Char('Reference', index=True, copy=False)
    ...
    notification_id = fields.One2many('sm.physician.notification', 'vital_signs_not_id',
                                      string='vital notification')
    ...
    def create(self, vals):
        vals['vital_signs_code'] = self.env['ir.sequence'].next_by_code('vital.signs')
        return super(VitalSigns, self).create(vals)
...
class ShifaNotificationInherit(models.Model):
    ...
    vital_signs_not_id = fields.Many2one('sm.shifa.vital.signs', string='vital signs', ondelete='cascade')
