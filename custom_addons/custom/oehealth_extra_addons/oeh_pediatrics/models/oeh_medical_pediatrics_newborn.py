...
class OeHealthPediatricsNewBorn(models.Model):
    ...
    doctor = fields.Many2one('oeh.medical.physician', domain=[('is_pharmacist','=',False)], string='Doctor in charge', readonly=True, states={'Draft': [('readonly', False)]}, default=_get_physician)
    signed_by = fields.Many2one('oeh.medical.physician', domain=[('is_pharmacist','=',False)], string='Signed by', readonly=True, states={'Draft': [('readonly', False)]})
