...
6) Record complete historical report based on Patient's Evaluation

7) Procedure Coding System for Medical : ICD-10-PCS

8) Patient Walkins Management

- Manage Doctor Walkin schedules
...
9) Record and print patient medical certificate with leave dates and reason
