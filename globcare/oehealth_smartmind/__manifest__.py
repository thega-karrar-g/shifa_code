...
{
    'name': 'Sehati Smartmind',
    'version': '1.0',
    'author': "Smart Mind Customization",
    'category': 'Generic Modules/Medical',
    'summary': 'Sehati Smartmind customizations',
    'depends': ['oehealth', 'oehealth_extra_addons'],
    'description': """oeHealth Smartmind customizations""",
    "website": "https://www.oehealth.in",
    "data": [
        'views/oehealth_appointment.xml',
        'views/lab_test.xml'
