...
class oeHealthRESTAPIToken(http.Controller):
    ...
    @http.route('/oehealth/request/token', methods=['GET'], type='http', auth='none', csrf=False)
    def request_token(self, **post):
        ...
        Example:
           ...
           eq = requests.post(
               '{}/oehealth/request/token'.format(base_url), data=data, headers=headers)
...
class oeHealthRESTAPIController(http.Controller):
    ...
    @authenticate_token
    @http.route(['/oehealth/get-user-details/<user_type>/<user_id>'], type='http', auth="none", methods=['GET'], csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/get-patient-list'], type='http', auth="none", methods=['GET'], csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/get-doctor-list'], type='http', auth="none", methods=['GET'], csrf=False)
    def get_doctor_list(self, doctor_type=None, **payload):
        ...
        model_name = 'oeh.medical.physician'
        model = request.env[self._model].sudo().search([('model', '=', model_name)], limit=1)
        # doctor_type = payload.get('doctor_type')

        # if doctor_type:
        #     payload['domain'] = "[('doctor_type', '=', " + str(doctor_type) + ")]"

        payload[
            'fields'] = "['id', 'name', 'speciality', 'degree_id', 'image_512', 'available_lines', 'doctor_type', 'consultancy_type', 'consultancy_price', 'appointment_type', 'prescription_count']"
    ...
    @authenticate_token
    @http.route(['/oehealth/get-prescription-info/<user_type>/<user_id>'], type='http', auth="none", methods=['GET'], csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/get-labtest-info/<user_type>/<user_id>'], type='http', auth="none", methods=['GET'],
                csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/get-appointment/<user_type>/<user_id>'], type='http', auth="none", methods=['GET'],
                csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/update-profile-photo/<user_type>/<user_id>'], type='http', auth="none", methods=['PUT'],
                csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/remove-profile-photo/<user_type>/<user_id>'], type='http', auth="none", methods=['GET'],
                csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/update-profile/<user_type>/<user_id>'], type='http', auth="none", methods=['POST'],
                csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/today-appointment/<user_type>/<user_id>'], type='http', auth="none", methods=['GET'],
                csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/notification/mute/<user_type>/<user_id>'], type='http', auth="none", methods=['GET'],
                csrf=False)
    ...
    @authenticate_token
    @http.route(['/oehealth/appointment/create'], type='http', auth="none", methods=['POST'],
                csrf=False)
    def create_appointment(self, **post):
        ...
        if model:
            try:
                ...
                doctor = request.env['oeh.medical.patient'].sudo().browse(int(doctor_id))
                if not doctor:
                    return invalid_response('invalid doctor_id', 'Invalid Doctor ID ! ')
                else:
                    values['doctor'] = doctor.id

                values['appointment_date'] = datetime.now()

                if 'patient_status' in post and post.get('patient_status') in ['Ambulatory','Outpatient','Inpatient']:
                    values['patient_status'] = post.get('patient_status')

                if 'urgency_level' in post and post.get('urgency_level') in ['Normal','Urgent','Medical Emergency']:
    ...
    @authenticate_token
    @http.route(['/oehealth/patient/registration'], type='http', auth="none", methods=['POST'],
                csrf=False)
        ...
        if model:
            try:
                ...
                if partner:
                    ...
                    username = post.get('username')
                    password = post.get('password')
                    search_patient = request.env[model_name].sudo().search([('patient_username','=', username)], limit=1)
                    if search_patient:
                        return invalid_response('patient already exists', 'Patient already exists, check your username!')
                    ...
                    dob_date = datetime.strptime(post.get('dob'), '%d/%m/%y').date()
                    ...
                    #     group_patient_id = request.env.ref('oehealth.group_oeh_medical_patient').id
                    #     user_values = {
                    #         'name': partner.name,
                    ...
                    #         'groups_id': [(6, 0, [group_employee_id,group_patient_id])]
                    #     }
    ...
    @authenticate_token
    @http.route(['/oehealth/patient/login'], type='http', auth="none", methods=['POST'],
                csrf=False)
    def patient_login(self, **post):
        ...
        if model:
            try:
                ...
                search_patient = request.env[model_name].sudo().search([('patient_username', '=', username),('patient_password', '=', password)], limit=1)
                patient_id = search_patient.id

                if not search_patient:
                    return invalid_response('No patient found, please enter valid username and password.')
            except Exception as e:
                print(e)
                return invalid_response('failed to login patient', 'Failed to login patient !')
            else:
                data = {
                    'id': patient_id,
